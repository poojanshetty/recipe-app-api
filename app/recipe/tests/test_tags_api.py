...
class PrivateTagsApiTests(TestCase):
    ...
    def test_tags_limited_to_user(self):
        """Test if tags returned are limited to user"""
    ...
    def test_filter_tags_assigned_to_recipes(self):
        """Test listing tags by those assined to recipe"""
        t1 = Tag.objects.create(user=self.user, name="Apple")
    ...
    def test_filtered_tags_unique(self):
        ...
        t = Tag.objects.create(user=self.user, name="Eggs")
