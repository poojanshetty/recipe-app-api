...
class PrivateRecipeApiTests(TestCase):
    """Test Autehticated API requests"""
    ...
    def test_partial_update(self):
        ...
        original_link = "url1.pdf"
        recipe = create_recipe_user(
            user=self.user,
            title="Sample recipe title",
            link=original_link,
        )
    ...
    def test_update_user_returns_error(self):
        ...
        new_user = create_user(email="user2@example.com", password="pass123@s")
        recipe = create_recipe_user(user=self.user)
    ...
    def test_delete_other_users_recipe_error(self):
        ...
        new_user = create_user(email="user2@example.com", password="pass1235@")
        recipe = create_recipe_user(user=new_user)
    ...
    def test_create_repice_with_new_tag(self):
    ...
    def test_clear_recipe_tags(self):
        """Test clearing tags on a recipe"""
    ...
    def test_clear_recipe_ingredients(self):
        """Test clearing recipie ingredient"""
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe_user(user=self.user, title="Thai Vegetable Curry")
        r2 = create_recipe_user(user=self.user, title="Thai Chicken Curry")
        tag1 = Tag.objects.create(user=self.user, name="Vegetable")
        tag2 = Tag.objects.create(user=self.user, name="Chicken")
        r1.tags.add(tag1)
        r2.tags.add(tag2)
        r3 = create_recipe_user(user=self.user, title="Fish and Chips")
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe_user(user=self.user, title="Thai Vegetable Curry")
        r2 = create_recipe_user(user=self.user, title="Thai Chicken Curry")
        in1 = Ingredient.objects.create(user=self.user, name="Coconut")
...
class ImageUploadTests(TestCase):
    ...
    def setUp(self):
        ...
        self.client.force_authenticate(self.user)
        self.recipe = create_recipe_user(user=self.user)
